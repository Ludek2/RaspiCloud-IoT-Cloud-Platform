...
then
  ...
  while [ 1 ]; do
    ...
    do
        $client_exec_file_path '{"stationId": "station1","date": "'$col1'","time": "'$col2'","maximum_wind_speed": "'$col3'","minimum_wind_speed": "'$col4'","mean_wind_speed": "'$col5'","wind_direction": "'$col6'","battery_voltage": "'$col7'","relative_humidity": "'$col8'","air_temperature": "'$col9'","net_solar_radiation": "'$col10'","rain_fall": "'$col11'","sent_from_iot_device_time": "'$(date +%s%N | cut -b1-13)'" }' 
       sleep 0.002
    done < dataSet.csv
